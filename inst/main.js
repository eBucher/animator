...
function draw() {
    // INSERT DEBUG SECONDS ELAPSED HERE //
...
// Add the onclick listeners to the HTML elements
document.getElementById("play").onclick = playButtonClick;
